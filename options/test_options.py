...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--pic_a_path", type=str, default='./demo_file/Iron_man.jpg', help="Person who provides identity information")
        ...
        self.parser.add_argument("--pic_specific_path", type=str, default='./demo_file/specific1.png', help="The specific person to be swapped")
